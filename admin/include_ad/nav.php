<nav class="navbar navbar-expand-lg navbar-light  sticky-top" style="background-color: #03658C;">
  <a class="navbar-brand font-weight-bold" href="../../index.php" style="color: yellow">THCS Nguyễn Kim Nha</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link text-light font-weight-bold" href="../../index.php">Trang chủ <span class="sr-only">(current)</span></a>
      </li>
      <?php
      if (isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["loai"] == 1) {
      ?>
        <li class="nav-item active">
          <a class="nav-link text-light font-weight-bold" href="../tongkettuan/index.php">Bảng điều khiển</a>
        </li>
      <?php
      } else if (isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["loai"] == 0) {
      ?>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
            <a class="dropdown-item" href="../../public/tongkettuan/index.php">Thi đua tuần</a>
            <a class="dropdown-item" href="../../public/noiquy/index.php">Nội quy</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-light font-weight-bold" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="../tructuan/index.php">Trực tuần</a>
            <a class="dropdown-item" href="../tongkettuan/index.php">Tổng kết tuần</a>
          </div>
        </li>
      <?php
      }
    ...
    <form class="form-inline ml-auto">
      <a style="color:yellow;"><?php include("../inc/menutaikhoan.php") ?></a>
    </form>
  </div>
</nav>
<!--form cap nhat ho so-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="../ktnguoidung/index.php?action=capnhat" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="txtdienthoai" placeholder="Số điện thoại" value="<?php echo $_SESSION["nguoidung"]["sodienthoai"]; ?>">
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="../ktnguoidung/index.php?action=doimatkhau" id="myform">
          <div class="form-group">
