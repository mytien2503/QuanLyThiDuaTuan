			...
			<div class="col-sm-4">
				<form method="post" class="form-signin" name="f">
					...
					<script>
						...
						<label for="text" class="sr-only form-control">Email</label>
						<input type="email" name="txtemail" class="form-control mb-3" placeholder="Email" required autofocus>
						<button class="btn btn-lg btn-primary btn-block" type="submit">Yêu cầu xác nhận</button>
						<input type="hidden" name="action" value="yeucauxacnhan">
				</form>
			</div>
			<script>
